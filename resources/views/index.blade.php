...
<body id="homepage">
    ...
    <div id="wrapper">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="col"><span class="id-color"><i class="fa fa-clock-o"></i></span>Saturday 10 June 2022 14:00 PM - 16:00
                                PM
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <nav>
                            <ul id="mainmenu">
                                <li><a href="02_index_multipage.html">Home</a></li>
                                <li><a href="02_speakers.html">Speakers</a></li>
                                <li><a href="02_schedules.html">Schedules</a></li>
                                <li><a href="02_sponsors.html">Sponsors</a></li>
                                <li><a href="02_tickets.html">Tickets</a></li>
                                <li><a href="02_info.html">Info</a></li>
                            </ul>
                        </nav>
        ...
        <div id="content" class="no-bottom no-top">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="spacer-double"></div>
                                    <h1 class="ultra-big">The Eventbiz <span class="id-color">'22</span></h1>
                                    <div class="spacer-single"></div>
                                    <div class="subtitle s2"><span><i class="fa fa-calendar-o id-color"></i>August 3rd to 5th</span><span><i class="fa fa-map-marker id-color"></i>Orlando, Florida.</span></div>
                                    <div class="spacer-single"></div>
                                    <div class="spacer-single"></div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center wow fadeInUp">
                            <h2>About Eventbiz</h2>
                            <p class="lead">The biggest digital event of the year</p>
                            <div class="spacer-single"></div>
                        </div>

                        <div class="col-md-4 text-center wow fadeInUp">
                            <i class="fa fa-bookmark id-color mb20 size40"></i>
                            <h3>Topics</h3>
                            <p>Large audiotorium with capacity of fifty thousand participants is also equipped with advanced
                                facilities for your pleasure.</p>
                        </div>

                        <div class="col-md-4 text-center wow fadeInUp">
                            <i class="fa fa-cogs id-color mb20 size40"></i>
                            <h3>Workshops</h3>
                            <p>The location of the seminar is located in the city center so it is easily reached by private
                                or public vehicles which available for 24 hours.</p>
                        </div>

                        <div class="col-md-4 text-center wow fadeInUp">
                            <i class="fa fa-info-circle id-color mb20 size40"></i>
                            <h3>Information</h3>
                            <p>There are many hotels available around the event location for temporary residence as long as
                                you follow this event, from motels to 5 stars.</p>
                        </div>
                    ...
                    <div class="row">
                        <div class="inner-padding">
                            <div class="col-md-5 wow fadeInLeft" data-wow-delay=".5s">
                                ...
                                <div class="spacer-single"></div>
                                <a href="service-1.html" class="btn-line">View Speakers</a>
                            </div>
                    ...
                    <div class="row">
                        <div class="inner-padding">
                            <div class="col-md-5 col-md-offset-7 wow fadeInRight" data-wow-delay=".5s">
                                <h2>More Than 20 Sponsors<span class="id-color">.</span></h2>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
                                    ...
                                    cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum..</p>
                                <div class="spacer-single"></div>
                                <a href="service-1.html" class="btn-line">View Sponsors</a>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
            ...
            <!-- section begin -->
            <section id="section-testimonial-no-bg" data-stellar-background-ratio=".2">
                        ...
                        <div id="testimonial-carousel" class="de_carousel wow fadeInUp">
                            ...
                            <div class="col-md-6 item">
                                <div class="de_testi opt-3">
                                    <blockquote>
                                        <p>I'm very happy with this event. I will recommend this to my family and friends. The
                                            speakers are professional. It's worth quality for the price.</p>
                            ...
                            <div class="col-md-6 item">
                                <div class="de_testi opt-3">
                                    <blockquote>
                                        <p>A wonderful event thank you! The best event as it proved by quality. I learn many
                                            digital things. I would definitely return for future events.</p>
                                        <div class="de_testi_by">
                            ...
                            <div class="col-md-6 item">
                                <div class="de_testi opt-3">
                                    <blockquote>
                                        <p>I will recommend this to my family and friends. I'm very happy with this event. The
                                            speakers are professional. It's worth quality for the price.</p>
                                        <div class="de_testi_by">
        ...
        <footer>
            ...
            <div class="subfooter">
                <div class="container text-center">
                    <div class="row">
                        <div class="col-md-12">
                            &copy; Copyright 2021 - Eventbiz by Designesia
                        </div>
                    </div>
                </div>
            </div>
